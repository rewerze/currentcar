          ...
          <div className="form">
            <div className="form-box bg-dark text-light">
              ...
              <div className="form-content mt-2">
                ...
                <input type="password" name="password" id="password" value={password} onChange={(e) => setPassword(e.target.value)} className="form-control" placeholder="Adja meg a jelszavát" />
              </div>
