...
('4000', 1, 'Reliable family sedan with excellent safety features', 'sedan', 5, 5, 1, 'Accord', 'W-AB-1234', 25, 125, 'excellent', 35000, 2022, 'hybrid', 'automatic', 'Honda'),
('5000', 1, 'Spacious SUV perfect for family trips and outdoor adventures', 'suv', 7, 5, 2, 'RAV4', 'M-CD-5678', 35, 175, 'excellent', 28000, 2021, 'hybrid', 'automatic', 'Toyota'),
('3000', 1, 'Compact hatchback with great city handling and fuel economy', 'hatchback', 5, 5, 3, 'Golf', 'B-EF-9012', 20, 100, 'good', 42000, 2020, 'petrol', 'manual', 'Volkswagen'),
('6000', 1, 'Luxury electric sedan with cutting-edge technology', 'sedan', 5, 5, 4, 'Model 3', 'K-GH-3456', 60, 300, 'excellent', 15000, 2022, 'electric', 'automatic', 'Tesla'),
('7000', 1, 'Sporty coupe with powerful engine and dynamic handling', 'coupe', 4, 3, 5, 'Mustang', 'F-IJ-7890', 45, 225, 'excellent', 20000, 2021, 'petrol', 'manual', 'Ford'),
('5000', 1, 'Premium crossover SUV with elegant design and comfort', 'suv', 5, 5, 6, 'CX-5', 'LEV-CX-504', 40, 200, 'excellent', 25000, 2022, 'petrol', 'automatic', 'Mazda'),
('8000', 1, 'Robust pickup truck for heavy duty tasks and adventures', 'pickup', 5, 5, 7, 'F-150', 'L-MN-5678', 40, 200, 'good', 45000, 2020, 'petrol', 'automatic', 'Ford'),
('6000', 1, 'Versatile mid-size SUV with off-road capabilities', 'suv', 5, 5, 8, 'Wrangler', 'F-OP-9012', 45, 225, 'excellent', 32000, 2021, 'petrol', 'manual', 'Jeep'),
('8000', 1, 'Luxury sedan with premium features and smooth ride', 'sedan', 5, 5, 9, 'E-Class', 'S-QR-3456', 50, 250, 'excellent', 25000, 2022, 'diesel', 'automatic', 'Mercedes-Benz'),
('4000', 1, 'Reliable compact SUV with excellent fuel efficiency', 'suv', 5, 5, 10, 'CR-V', 'B-ST-7890', 30, 150, 'good', 35000, 2021, 'hybrid', 'automatic', 'Honda'),
('5000', 1, 'Economical compact sedan with modern safety features', 'sedan', 5, 5, 11, 'Civic', 'W-UV-1234', 20, 100, 'good', 40000, 2020, 'petrol', 'automatic', 'Honda'),
('7000', 1, 'Premium electric SUV with long range and performance', 'suv', 5, 5, 12, 'Model Y', 'M-WX-5678', 65, 325, 'excellent', 18000, 2022, 'electric', 'automatic', 'Tesla'),
('4000', 1, 'Stylish compact SUV with distinctive design', 'suv', 5, 5, 13, 'Sportage', 'B-YZ-9012', 30, 150, 'good', 30000, 2021, 'petrol', 'automatic', 'Kia'),
('9000', 1, 'Premium luxury SUV with cutting-edge technology and comfort', 'suv', 7, 5, 14, 'X5', 'K-CD-7890', 60, 300, 'excellent', 22000, 2022, 'hybrid', 'automatic', 'BMW');
...
('Andrássy út 66, Budapest, Hungary'),
('Vaci utca 18, Budapest, Hungary'),
('Üllői út 131, Budapest, Hungary'),
('Árpád fejedelem útja 26-28, Budapest, Hungary'),
('Nagytétényi út 37-43, Budapest, Hungary'),
('Bocskai út 77-79, Budaörs, Hungary'),
('Szentendrei út 24, Pomáz, Hungary');
...
(3, 1, 'The infotainment system is a bit confusing to use at first but works well once you get used to it.', 3, '2023-05-12 16:30:00', 'safety', 0),
...
(5, 2, 'The hybrid system provides excellent fuel economy even when driving in the city.', 5, '2023-04-18 10:20:00', 'fuel_efficiency', 0),
(6, 2, 'Good handling for an SUV, but the lane-keeping assist is too aggressive.', 4, '2023-05-25 14:10:00', 'performance', 0),
(7, 2, 'Plenty of cargo space. We fit all our camping gear with room to spare.', 5, '2023-07-03 09:00:00', 'fuel_efficiency', 0),
...
(10, 3, 'Great fuel economy and compact size makes parking a breeze.', 5, '2023-06-05 13:25:00', 'safety', 0),
(11, 3, 'The interior feels premium for its class. Well-built with quality materials.', 4, '2023-07-18 15:40:00', 'safety', 0),
...
(13, 4, 'The minimalist interior takes some getting used to but works well.', 4, '2023-04-26 14:30:00', 'performance', 0),
(14, 4, 'Autopilot feature made my highway commute much less stressful.', 5, '2023-06-10 09:20:00', 'comfort', 0),
(10, 4, 'Range anxiety wasn\'t an issue. Plenty of charging stations on our route.', 4, '2023-07-22 11:45:00', 'comfort', 0),
...
(13, 5, 'Fuel economy is poor but that\'s expected with this much power.', 2, '2023-07-28 14:10:00', 'fuel_efficiency', 0),

-- Mazda CX-5 (car_id: 6)
(3, 6, 'Premium feel without the premium price. Interior quality is exceptional.', 5, '2023-03-22 11:25:00', 'safety', 0),
...
-- Ford F-150 (car_id: 7)
(11, 7, 'Fuel economy is what you\'d expect from a full-size truck - not great.', 2, '2023-06-25 13:40:00', 'fuel_efficiency', 0),
(12, 7, 'The bed size and features are perfect for my construction business.', 5, '2023-08-07 11:05:00', 'safety', 0),
...
(1, 8, 'Removing the doors and roof was fun for summer driving.', 5, '2023-06-30 14:25:00', 'value_for_money', 0),

-- Mercedes-Benz E-Class (car_id: 9)
(10, 9, 'Luxurious interior with exceptional build quality. Every detail is perfect.', 5, '2023-03-30 13:20:00', 'value_for_money', 0),
(14, 9, 'Smooth and quiet ride even on rough roads. Perfect for long trips.', 5, '2023-05-18 11:40:00', 'comfort', 0),
(8, 9, 'Excellent diesel engine with surprising efficiency for its size.', 4, '2023-08-15 10:30:00', 'fuel_efficiency', 0),

-- Honda CR-V (car_id: 10)
(3, 10, 'Perfect family SUV with excellent safety features.', 5, '2023-04-02 15:45:00', 'safety', 0),
(10, 10, 'The hybrid system is smooth and provides great fuel economy.', 5, '2023-05-22 12:20:00', 'fuel_efficiency', 0),
(2, 10, 'Cargo space is excellent. Easily fits all our luggage for family trips.', 4, '2023-07-10 09:35:00', 'performance', 0),
...
(4, 12, 'The minimalist interior is both beautiful and functional.', 5, '2023-05-30 10:45:00', 'value_for_money', 0),
(6, 12, 'Autopilot made our long road trip much less tiring.', 5, '2023-07-15 15:30:00', 'safety', 0),
(7, 12, 'Some build quality issues with panel gaps, but nothing major.', 3, '2023-08-27 11:15:00', 'comfort', 0),

-- Kia Sportage (car_id: 13)
(8, 13, 'Great value for money. Lots of features for the price.', 4, '2023-04-12 09:25:00', 'comfort', 0),
(9, 13, 'The new design is eye-catching and stands out from other SUVs.', 5, '2023-06-02 13:50:00', 'safety', 0),
...
(4, 14, 'The hybrid system provides good efficiency for a large SUV.', 4, '2023-07-22 09:15:00', 'value_for_money', 0),
(14, 14, 'Technology features are comprehensive but the interface has a learning curve.', 4, '2023-09-02 12:45:00', 'safety', 0);
